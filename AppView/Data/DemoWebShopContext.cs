...
public partial class DemoWebShopContext : DbContext
{
    public DemoWebShopContext()
    {
    }

    public DemoWebShopContext(DbContextOptions<DemoWebShopContext> options)
        : base(options)
    {
    }
...
//        => optionsBuilder.UseSqlServer("Data Source=LUAN;Initial Catalog=DemoWebShop;Integrated Security=True;Trust Server Certificate=True");
