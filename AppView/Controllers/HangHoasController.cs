...
namespace AppView.Controllers
{
    ...
    {
        private readonly DemoWebShopContext _context;

        public HangHoasController(DemoWebShopContext context)
        {
            _context = context;
        }
        ...
        {
            var demoWebShopContext = _context.HangHoas.Include(h => h.MaLoaiNavigation).Include(h => h.MaNccNavigation);
            return View(await demoWebShopContext.ToListAsync());
        }
